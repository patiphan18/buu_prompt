			...
			for(int i=0; i<count; i++) {
				...
				for(int j=0; j<count-i-1; j++) {
					...
					if(temp->name > temp->link->name) {
						...
						temp->link->password = tempPassword;
						
						string tempName = temp->name;
						temp->name = temp->link->name;
						temp->link->name = tempName;
						
						string tempVaccineType = temp->vaccineType;
						temp->vaccineType = temp->link->vaccineType;
						temp->link->vaccineType = tempVaccineType;
						
						string tempAcceptDose = temp->acceptDose;
						temp->acceptDose = temp->link->acceptDose;
						temp->link->acceptDose = tempAcceptDose;
						
						string tempDate1 = temp->date1;
						temp->date1 = temp->link->date1;
						temp->link->date1 = tempDate1;
						
						string tempDate2 = temp->date2;
						temp->date2 = temp->link->date2;
						temp->link->date2 = tempDate2;
						
						string tempLocation = temp->location;
						temp->location = temp->link->location;
						temp->link->location = tempLocation;
					} // swap data
